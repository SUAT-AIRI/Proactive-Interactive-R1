...
if __name__ == "__main__":
    # For test
    solution_str = """\nuser\nWhat is 2 + 2?\nassistant\nTo solve 2 + 2, we simply add the two numbers together. The sum of 2 and 2 is 4.\nuser\nWhat is 3 * 3?\nassistant\nTo solve 3 * 3, we multiply the two numbers together. The product of 3 and 3 is 9."""
    ground_truth = "The answer is \\boxed{4}."
    extra_info = {
        "single_turn_prompt_raw": "Calculate the sum of two numbers.",
        "insufficient_question": "What is 2 + 2?"
    }
